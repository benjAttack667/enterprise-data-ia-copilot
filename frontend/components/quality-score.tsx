...
const labels: Record<string, string> = {
  ...
  blank_count: 'Chaînes vides',
  invalid_date_count: 'Dates invalides',
  invalid_semantic_count: 'Valeurs invalides',
  invalid_numeric_count: 'Lignes avec non-fini',
  invalid_numeric_cell_count: 'Cellules non finies',
